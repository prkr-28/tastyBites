      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-8 sm:py-12 lg:py-16 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-10 left-10 animate-bounce" style={{ animationDelay: '0s', animationDuration: '3s' }}>
            <svg className="w-12 h-12 sm:w-16 sm:h-16 text-yellow-300 opacity-20" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="absolute top-20 right-16 animate-bounce" style={{ animationDelay: '1s', animationDuration: '4s' }}>
            <svg className="w-10 h-10 sm:w-14 sm:h-14 text-orange-300 opacity-20" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="absolute bottom-20 left-20 animate-bounce" style={{ animationDelay: '2s', animationDuration: '3.5s' }}>
            <svg className="w-8 h-8 sm:w-12 sm:h-12 text-green-300 opacity-20" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="absolute bottom-32 right-8 animate-bounce" style={{ animationDelay: '0.5s', animationDuration: '4.5s' }}>
            <svg className="w-10 h-10 sm:w-14 sm:h-14 text-pink-300 opacity-20" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm0-14c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z"/>
            </svg>
          </div>

          {/* Ice Cream SVG */}
          <div className="absolute top-32 left-1/2 animate-bounce" style={{ animationDelay: '1.5s', animationDuration: '3.8s' }}>
            <svg className="w-8 h-8 sm:w-12 sm:h-12 text-blue-300 opacity-20" fill="currentColor" viewBox="0 0 24 24">
              <path d="M5 4v3h5.5l2.5 2.5L15.5 7H21V4H5zM7 10v8l5-3 5 3v-8H7z"/>
            </svg>
          </div>

          {/* Coffee SVG */}
          <div className="absolute top-16 right-1/3 animate-bounce" style={{ animationDelay: '2.5s', animationDuration: '4.2s' }}>
            <svg className="w-6 h-6 sm:w-10 sm:h-10 text-yellow-200 opacity-20" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-sm sm:text-base opacity-90">
              Delivering to: <span className="font-semibold">{location.address}</span>
            </span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-4">
            <button
              ...
              className="bg-white bg-opacity-20 hover:bg-opacity-30 text-white font-medium px-4 py-2 rounded-lg transition-all duration-200 flex items-center space-x-2 text-sm sm:text-base disabled:opacity-50"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
              <span>{location.loading ? 'Getting Location...' : 'Use Current Location'}</span>
            </button>
            
            <button
              onClick={() => setIsLocationModalOpen(true)}
              className="bg-white bg-opacity-20 hover:bg-opacity-30 text-white font-medium px-4 py-2 rounded-lg transition-all duration-200 text-sm sm:text-base"
            >
              Change Location
            </button>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="mb-4 sm:mb-6">
          <p className="text-gray-600 text-sm sm:text-base">
            Showing {filteredrestro.length} restaurant{filteredrestro.length !== 1 ? 's' : ''} near {location.address}
          </p>
        </div>
